...
// news_write.jsp 페이지로부터 전달받은 파라미터를 NewsBean 객체에 저장
...
// NewsDAO 객체의 insertNews() 메서드를 호출하여 게시물 등록 작업 요청
// => 파라미터 : NewsBean 객체   리턴타입 : int(insertCount)
NewsDAO newsDAO = new NewsDAO();
int insertCount = newsDAO.insertNews(news);

// 게시물 등록 작업 요청 결과 처리
// => 성공 시 news.jsp 페이지로 포워딩
