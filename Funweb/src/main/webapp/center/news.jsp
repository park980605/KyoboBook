...
int listCount = newsDAO.selectListCount();
...
// ----------------------------------------------------------------------------------------
// NewsDAO 객체의 selectNewsList() 메서드를 호출하여 게시물 목록 조회 작업 요청
	...
	<div id="wrap">
		...
		<article>
			...
			<table id="notice">
				...
				<tr
					onclick="location.href='news_content.jsp?num=<%=news.getNum()%>&page=<%=pageNum%>'">
					<td><%=news.getNum()%></td>
			...
			<div id="table_search">
				<input type="button" value="글쓰기" class="btn"
					onclick="location.href='news_write.jsp'">
			</div>

			<div id="table_search">
				<form action="news_search.jsp" method="get">
					<input type="text" name="search" class="input_box"
						placeholder="검색어 입력"> <input type="submit" value="Search"
						class="btn">
				</form>
			</div>
			<!-- 페이징 처리 -->
