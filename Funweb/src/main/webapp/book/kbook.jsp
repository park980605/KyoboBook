...
int listCount = bookDAO.selectKBookListCount();
...
ArrayList<BookBean> bookList = bookDAO.selectKBookList(pageNum, listLimit);
		...
		<article>
         ...
         <%} %>
			...
			<div id="page_control">
				...
				%>
				<a href="kbook.jsp?page=<%=pageNum - 1%>">Prev</a>
				<%
				...
				%>
				<a href="kbook.jsp?page=<%=pageNum + 1%>">Next</a>
				<%
				} else { // 이전페이지가 존재하지 않을 경우
				%>
				&nbsp;Next
