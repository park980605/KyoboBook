...
int listCount = bookDAO.selectEBookListCount();
...
ArrayList<BookBean> bookList = bookDAO.selectEBookList(pageNum, listLimit);
		...
		<article>
         ...
         <%} %>
			...
			<div id="page_control">
				...
				%>
				<a href="ebook.jsp?page=<%=pageNum - 1%>">Prev</a>
				<%
				...
				%>
				<a href="ebook.jsp?page=<%=pageNum + 1%>">Next</a>
				<%
				} else { // 이전페이지가 존재하지 않을 경우
				%>
				&nbsp;Next
